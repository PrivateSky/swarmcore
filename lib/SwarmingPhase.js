...
SwarmingPhase.prototype.broadcast = function (phaseName,groupName) {
    ...
    var nodes = thisAdpater.nativeMiddleware.getGroupNodes.async(groupName);
    var self = this;
    (function(nodes){
...
SwarmingPhase.prototype.swarm = function (phaseName, nodeHint) {
    ...
    try {
        ...
        mySwarm.meta.phaseIdentity = thisAdapter.nativeMiddleware.createSwarmIdentity(mySwarm);
