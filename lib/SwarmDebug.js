...
container("swarmLoggingMonitor", ["swarmingIsWorking", "swarmComImpl"], function(outOfService,swarming, swarmComImpl){
    console.log("\n\n\n\nLOGGER FUNCTION OVERWRITTEN!!!!!!!!!!!!!\n\n\n\n\n")

container("swarmLoggingMonitor", ["swarmingIsWorking", "networkLogger", "swarmComImpl"], function(outOfService,swarming, networkLogger, swarmComImpl){
    if(outOfService){
        ...
        logger.record = function(record){
            console.log("\n\n\n\n\nThe logger loggs something!!!!!!!!!!",record)
            currentSwarmComImpl.recordLog(record);
        }
