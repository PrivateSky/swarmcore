...
var monitor = require('semantic-firewall');
...
container.service("swarmLoggingMonitor", ["swarmingIsWorking", "networkLogger"], function(outOfService,swarming, networkLogger){
    if(outOfService){
        if(!temporaryLogBuffer){
            temporaryLogBuffer = [];
        }
