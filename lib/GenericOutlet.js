    ...
    var executeSafe = function (messageObj) {
        ...
        try {
            if (messageObj.meta.command == "getIdentity") {
                ...
                var userId = messageObj.meta.userId?messageObj.meta.userId:"NO_USER";
                checkAccess("swarm",messageObj.meta.swarmingName,"ctor",messageObj.meta.ctor,"execution",userId,function(err,hasRights) {
                    if (err) {
