...
function AdapterCore(mainGroup, config, swarmComImpl) {
        ...
        try {
            ...
            if (phaseFunction != null) {
                try {
                    ...
                    logErr("Error when running swarm: " + swarmingPhase.meta.swarmingName + "  Phase: " + swarmingPhase.meta.currentPhase, err);
                    executionError = err;
                }
            }
            else {
    ...
    this.observeGlobal = function(globalId, swarm, phaseName, target){
        swarmComImpl.observeGlobal(groupName);
    }

    this.notifyGlobal = function(globalId){
        swarmComImpl.notifyGlobal(groupName);
    }
