...
createSwarmCallback = function (callBack, debugString) {
    ...
    return function () {
        ...
        try{
            ...
            logErr("Unexpected error when calling swarmified callback in swarm execution context: " + ctxt.currentSwarm.meta.swarmingName + " in phase " + ctxt.currentSwarm.meta.currentPhase, err);
        }
